...
<head>
  ...
  <title>Admin - Danh sách học phần</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Hiển thị bảng danh sách học phần sinh viên</div>
          <div class="card-body">
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $value['ten_lop']; ?></td> <td>
            ...
            <div class="card-footer small text-muted">Cập nhật lúc 11:59</div>
          </div>
        </div>
        </div>
    </div>
