...
<head>
  ...
  <title>Admin - Sửa học phần</title>
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            <div class="card-header">Cập nhật thông tin học phần</div>
            <div class="card-body">
              <form action="#" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="sel1" name="sellist1">
                    <?php foreach ($listhocky as $h) { ?>
                      <option value="<?php echo $h['ma_hk']; ?>" <?php echo ($h['ma_hk'] == $value['ma_hk']) ? "selected" : ""; ?>>
                        <?php echo $h['ten_hk']; ?>
                      </option>
                    <?php } ?>
                  </select>
                ...
                <div class="form-group">
                  <label for="sellist_lop">Lớp học phần:</label>
                  <select class="form-control" id="sellist_lop" name="sellist_lop" required="required">
                    <option value="">-- Chọn lớp học --</option>
                    <?php foreach ($list_lop as $lop) { ?>
                      <option value="<?php echo $lop['ma_lop']; ?>" <?php echo ($lop['ma_lop'] == $value['ma_lop']) ? "selected" : ""; ?>>
                ...
                <input type="submit" name="suaHocphan" class="btn btn-primary btn-block" value="Cập nhật thông tin">
                
                <?php } // Kết thúc vòng lặp foreach $list_id_hocphan ?>
              </form>
            </div>
          </div>
        </div>
