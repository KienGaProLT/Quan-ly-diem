                ...
                <?php foreach ($list_sv as $value) {
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      <input type="text" name="txt_masv" id="inputMasv" class="form-control" placeholder="Mã sinh viên"
                        value="<?php echo $value['ma_sv']; ?>" required="required" readonly
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      <input type="text" name="txt_hoten" id="inputTensv" class="form-control" placeholder="Họ và tên"
                        value="<?php echo $value['hoten_sv']; ?>" required="required">
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      <input type="date" name="txt_ngaysinh" id="inputNgaysinh" class="form-control"
                        placeholder="Ngày sinh" value="<?php echo $value['ngay_sinh']; ?>" required="required">
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      <input type="text" name="txt_dantoc" id="inputDanto" class="form-control" placeholder="Dân tộc"
                        value="<?php echo $value['dan_toc']; ?>" required="required">
                      <label for="inputDanto">Dân tộc</label>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-label-group">
                      <input type="text" name="txt_noisinh" id="inputNoisinh" class="form-control" placeholder="Nơi sinh"
                        value="<?php echo $value['noi_sinh']; ?>" required="required">
